...
export default function BetsPage() {
  ...
  const createBet = async () => {
    ...
    try {
      ...
      setMessage(`Bet created: ${title} · €${amount.toFixed(0)}${selectedPreset.scope === "hole" ? ` · Hole ${currentHole}` : ""}`);
